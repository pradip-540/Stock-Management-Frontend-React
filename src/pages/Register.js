...
function Register() {
  ...
  return (
    <>
      <div className="grid grid-cols-1 sm:grid-cols-2 h-screen bg-slate-100 items-center place-items-center">
        ...
        <div className="flex justify-center order-first sm:order-last">
          <img src="https://www.netsuite.com/portal/assets/img/business-articles/inventory-management/infographic-business-solutions-retail-inventory-management.png" alt="" />
        </div>
      </div>
